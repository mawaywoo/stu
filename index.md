...
804. 为什么不直接从T诱导到G，而是先诱导到中间群B，那是因为T到G差别太大（导致**诱导表示里含的不可约表示比较多**），最后使得分解不可约表示会比较困难，见 4:37；**特征标 <----> 不动点 <----> 交错上同调**，见 8:00；**诱导表示的不可约表示的分解比较困难，怎么办，我们把它提升到特征标层，借助特征标层的分析，再拉回到特征标的分解**，这就是特征标层的意义，见 12:24 [Deligne-Lusztig theory and character sheaves](https://www.youtube.com/watch?v=J7QTNT25yYU) 2025-6-30 16:23 崇德苑 209 室
