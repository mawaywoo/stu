...
916. Fin_* 和 Delta 是两个**不一样**的范畴（**对象分别为 < n > 和 [n]**），**前者编码 monoidal 结构，后者编码 infinity 结构（Delta 记录的是各 n-态射，把它替换为 Dendroidal Set，便得到 multicategory/operad）**。2025-11-22 15:33 崇德苑 209 室 
