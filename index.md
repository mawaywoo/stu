...
1102. [Cubical_maps_examples_n=1-3 deepseek](https://github.com/mawaywoo/stu/blob/mawaywoo/Cubical_maps_examples_n%3D1-3%20deepseek.pdf) 为了理解以下关于 Cubical Set 的文章，前面的例子对  Cubical Set 的相关概念的理解很有帮助（**[1]^n 表示分量取 0 或者 1 的 n 维点坐标，即边长为 1 的在第一象限的 n 维方体的各顶点的坐标**）：[A co-reflection of cubical sets into simplicial sets with applications to model structures](https://arxiv.org/pdf/1906.09203) and [A cubical approach to straightening](https://www.math.uwo.ca/faculty/kapulkin/papers/cubical-approach-to-straightening.pdf) and [A cubical model for (∞,n)-categories](https://arxiv.org/pdf/2005.07603) 2026-8-3 20:22 崇德苑 209 室
