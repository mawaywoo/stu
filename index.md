...
603. a. 理清楚某条件是复形等价类的条件还是复形本身的条件。比如界条件。将A视为D(A)是等价类地嵌入。b. 如模导出范畴可以视为投射模的同伦范畴就是考虑复形的等价类条件。c. Ext是导出函子，考虑的也是对象等价类之间的关系，而非对象本身之间的关系，所以我们可以取等价类中特殊的代表元(如投射分解)来计算它。2023-12-23 22:56
