...
923. **inert 态射表示一个“没有乘法结构”（输入端不做任何乘法）** 的态射，见 Tonny Yuyue 5，**无穷版本的代数和模都是通过无穷 operad (先构造通常的 operad Assoc, LM, 然后通过 tensor 构造，产生无穷版本 Assoc^tensor, LM^tensor)来编码的**，operad 可以用来编码“代数结构”。**Assoc operad 是 Fin_star 的“一部分”，比 Fin_star 里的态射“少一些”**。2025-12-2 16:52 崇德苑 209 室
