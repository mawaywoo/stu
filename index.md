...
659. 对于自正交范畴 T，**可以找到一个介于 T 和 T^{\perp} 之间的范畴：X_T, 即包含 T 且使 T 为投射对象的最大的范畴**。 T < X_T < T^{\perp}，中间范畴 X_T 是怎样由 T 生成也是比较清楚的。[Tilting subcategories in extriangulated categories](https://arxiv.org/pdf/1907.00747.pdf) 2024-3-8 10:32 岭南师范学院图书馆六楼西区 3 座位 002.
