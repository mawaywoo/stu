...
| D | E | F |
|:---------|:---------------------|:---------------|
[Lucas Mann: Representation Theory via 6-Functor Formalisms](https://www.youtube.com/watch?v=UlV5TCsLcBQ) | [国际基础科学大会](https://www.icbs.cn/en/web/program/18009) |
...
550.  为什么要在意双范畴或者高阶范畴：因为我们有时确实**需要同时编码多组数据**。交换图中的**每一个箭头都代表着一堆数据**。[Robert Paré: Some things about double categories](https://www.youtube.com/watch?v=ArC7wBqHp5Q) 
