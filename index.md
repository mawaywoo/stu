...
908. 范畴可以分解为为由1个1-态射的集合，2个1-态射的合成集合，按此可以推广到无穷范畴，单纯集范畴 delta 里面编码的就是各种多个态射的合成集（以及它们之间的匹配关系），**delta 里面记录着无穷** [1],[2],[3],... 见 29:00. **无穷范畴 = 按各态射的合成长度分层储存**。[BilTop Rune Haugseng Higher Morita categories](https://www.youtube.com/watch?v=67gGDM0ouS8) 2025-11-9 13:10 崇德苑 209 室
