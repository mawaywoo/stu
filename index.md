...
826. 用物理来理解范畴论，如 Yoneda 定理：Hom(-,X) 更能理解 X 是不可及的时候，那些态射（即探测器们）的重要性了，探测器是可以着手的，但关于 X 的一切都是无法着手的。完全用这些探测器（到 X 的所有态射）去了解 X 的性质，这个物理上的思想很好地解释了范畴论的思想。["Higher Topos Theory for Physics", talk by Urs Schreiber at Wolfram Winter School on Physics 2024](https://www.youtube.com/watch?v=GD20W6vxMI4&t=304s) 2025-7-11 11:25 崇德苑 209 室
