...
816. **重要的 slogan: 利用施加作用对象的“特征值”（其本质就是利用施加作用的对象的“幂等元的分解”，特征值是产生幂等元 A-lambdaE 的一种方式），可以得到被作用对象的分解**。例子：高代线性变换的特征值，还有模表示论的 G-代数的幂等元，以及前面提到的傅里叶变换的例子…… 2025-7-6 18:03 崇德苑 209 室
